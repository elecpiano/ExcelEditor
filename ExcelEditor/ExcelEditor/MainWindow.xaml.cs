...
namespace ExcelEditor
{
    public partial class MainWindow : System.Windows.Window
    {
        ...
        private void InitData()
        {
            ...
            item.ID = "1";
            item.Title = "地中海式风格";
            item.DescriptionImage = "/Assets/StyleDescription01.png";
            ...
            item.ID = "2";
            item.Title = "法式风格";
            item.DescriptionImage = "/Assets/StyleDescription02.png";          
            ...
            item.ID = "3";
            item.Title = "现代风格";
            item.DescriptionImage = "/Assets/StyleDescription03.png";
            ...
            item.ID = "4";
            item.Title = "新古典风格";
            item.DescriptionImage = "/Assets/StyleDescription04.png";
            ...
            item.ID = "5";
            item.Title = "新亚洲风格";
            item.DescriptionImage = "/Assets/StyleDescription05.png";
